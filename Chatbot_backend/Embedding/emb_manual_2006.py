...
OUT_EMB   = BASE / "emb_manual_2006.npz"         # vectors
OUT_META  = BASE / "emb_manual_2006_meta.json"   # metadata for each vector
FAISS_OUT = BASE.parent / "VectorDB" / "faiss_manual_2006.index"     # write to VectorDB
...
if __name__ == "__main__":
    ...
    # Optional: FAISS index (Inner Product since vectors normalized)
    try:
        import faiss
